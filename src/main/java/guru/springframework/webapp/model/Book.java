...
public class Book {
    ...
    public Book(String title, String isbn, Publisher publischer) {
        this.title = title;
        this.isbn = isbn;
        this.publischer = publischer;
    }

    public Book(String title, String isbn, Publisher publischer, Set<Author> authors) {
        this.title = title;
        this.isbn = isbn;
        this.publischer = publischer;
